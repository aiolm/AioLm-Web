...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return publicMetadata(locale, '/benchmarks', `${t('benchmark.Benchmark explorer')} · AioLM`, t('benchmark.Explore self-reported AioLM benchmark results with the hardware, workload and measurement method they were produced with.'));
}
